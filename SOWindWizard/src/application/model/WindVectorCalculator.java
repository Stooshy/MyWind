...
//    private static double[] factorsY = new double[]{-1.98, -1.97, -1.81, -1.58, -1.17, 1.21, 1.57, 1.84, 1.98, 1.97, 1.81, 1.58, 1.17, -1.21, -1.57, -1.84};
    private static double[] factorsY = new double[]{-0.98, -0.97, -0.81, -0.58, -0.17, 0.21, 0.57, 0.84, 0.98, 0.97, 0.81, 0.58, 0.17, -0.21, -0.57, -0.84};
     ...
     * @param wind in m/s.
     * @return x,y vectors , x in [m/s], y in [m/s]
     */
